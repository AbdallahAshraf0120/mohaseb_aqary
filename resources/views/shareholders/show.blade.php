        ...
        <div class="col-lg-4">
            <div class="card app-surface h-100 border-secondary-subtle">
                ...
                <div class="card-body small text-muted">
                    ...
                    <p class="mb-0"><strong>جاري المساهم (تقريبي):</strong> المنسب التشغيلي (تحصيلات + مقدمات <strong>المعتمدة فقط</strong>) ناقص حصة التكاليف؛ العمليات المعلّقة لا تدخل حتى الاعتماد.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-4 align-items-stretch">
                ...
                <div class="col-lg-7">
                    ...
                    <ul class="small text-body-secondary mb-0 ps-3">
                        <li class="mb-2">تُحتسب فقط البيعات والتحصيلات <strong>المعتمدة</strong> (مثل التقارير والصندوق).</li>
                        <li class="mb-2">التحصيلات تُؤخذ من سجلات التحصيل المرتبطة بالعقود على كل عقار.</li>
                        <li class="mb-2">المقدمات تُؤخذ من حقل مقدم البيعة لكل بيعة معتمدة على العقار (وارد الصندوق عند تسجيل البيعة).</li>
